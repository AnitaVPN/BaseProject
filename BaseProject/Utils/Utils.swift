...
class Utils: NSObject {
    ...
    func addLeftViewToTextFeild (textFeild : UITextField , image:UIImage , strPlaceHolder:String,padding:CGFloat)
    {
        ...
        leftView.frame = CGRect(x: 0, y: 0, width: 25, height: textFeild.frame.size.height)
        leftImageView.frame = CGRect(x: 8, y: textFeild.frame.size.height/2 - 5, width: 10, height: 10)
